...
const primaryCtaClass =
   "flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-semibold shadow-md shadow-indigo-200 transition-all border-none cursor-pointer";
...
const JobDetailsCard = ({
   ...
   const canManageJob = user === "admin" || user === "owner";
   ...
   return (
      <div
         className={`bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden
            ${showApply && !applied ? "lg:flex-1 lg:min-w-0 w-full lg:sticky lg:top-20" : "w-full"}`}
      >
         {/* Header */}
         ...
         {/* CTA Buttons */}
         {!showApply && (isSeeker || canManageJob) && (
